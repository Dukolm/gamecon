...
import { Pohlavi } from "@gamecon/api/src/přihlášenýUživatel";
import { generujUrl } from "../../store/logic/url";
import { useAktivita, useUrlState, useUživatelPohlaví } from "../../store/selektory";
import { Aktivita } from "../../store/slices/programDataSlice";
import { nastavUrlAktivitaNáhledId } from "../../store/slices/urlSlice";
import { volnoTypZObsazenost } from "@gamecon/core/src/utils/index";
