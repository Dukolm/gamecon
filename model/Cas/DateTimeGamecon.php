...
class DateTimeGamecon extends DateTimeCz
{
    ...
    public static function denPodleIndexuOdZacatkuGameconu(int $indexDneKZacatkuGc, int $rocnik = ROCNIK): string
    {
        ...
        $englishOrCzechDayName = static::spocitejZacatekGameconu($rocnik)->modify("$indexDneVuciStrede days")->format('l');
    ...
    protected static function zDbFormatu(string $datum): static
    {
    ...
    public static function zacatekRegistraciUcastniku(int $rocnik = ROCNIK): static
    {
    ...
    public static function konecRegistraciUcastniku(int $rocnik = ROCNIK): static
    {
